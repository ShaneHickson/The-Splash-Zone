...
function App() {
  ...
  const figures = [
    ...
    { img: splasher11, name: "Kian", bio: "The most cool and preformative 🌹", stats: { Wetness: 8, Trolling: 5, Speedrunning: 2,Aura: 8  } },
    ...
    { img: splasher12, name: "Cole", bio: "Handsome, genius, kind, humble 🥳", stats: { Wetness: 6, Trolling: 4, Speedrunning: 5, Aura: 10  } },
