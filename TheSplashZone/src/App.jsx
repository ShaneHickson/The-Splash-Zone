...
function App() {
  ...
  const figures = [
    ...
    { img: splasher11,alias: "Keieon", name: "(Kian)", bio: "The most cool and performative 🌹", stats: { Wetness: 10, RageBaiting: 5, Speedrunning: 2,Aura: 9,Brainrot: 7  }, colour: "#99ecabff" },
    ...
    { img: newsplasher00,alias: "Bing Bong", name: "(Kai)", bio: "Chaotic genius of the jungle 🐒", stats: { Wetness: 7, RageBaiting: 5, Speedrunning: 1,Aura: 7,Brainrot: 7}, colour: "#068f22ff" },
